...
> = {
  text: {
    ...
    philosophy:
      "Text is the foundation of digital communication. Our text tools help you clean, format, and analyze text effortlessly, ensuring your content is always clear and professional.",
    tools: [
      {
        id: "word-counter",
        name: "Word Counter",
        description:
          "Count words, characters, sentences, and paragraphs instantly. Get detailed text statistics.",
        features: [
          "Real-time counting",
          "Character breakdown",
      ...
      },
      {
        ...
        name: "Text Formatter",
        description:
          "Remove extra spaces, line breaks, and format text for clean presentation.",
        features: [
          "Remove duplicates",
          "Trim whitespace",
  ...
  image: {
    ...
    philosophy:
      "Images need to be optimized for the web without sacrificing quality. Our image tools provide professional-grade compression and conversion while maintaining visual fidelity.",
    tools: [
      {
        id: "image-compressor",
      ...
      },
      {
        ...
        description:
          "Convert between PNG, JPG, WebP, and other image formats seamlessly.",
      ...
      },
      {
        ...
        name: "Image Resizer",
        description:
          "Resize images to exact dimensions or by percentage. Maintain aspect ratio.",
  ...
  pdf: {
    ...
    philosophy:
      "PDF documents are essential for professional communication. Our tools make it easy to manipulate PDFs without expensive software, giving you complete control over your documents.",
    tools: [
      {
        id: "pdf-merger",
        name: "PDF Merger",
  ...
  data: {
    ...
    philosophy:
      "Data comes in many formats, and converting between them shouldn't be painful. Our data tools handle the complexity of format conversion and validation automatically.",
    tools: [
      {
        id: "csv-converter",
        name: "CSV Converter",
        description:
          "Convert CSV to JSON, XML, or Excel. Support for custom delimiters.",
        features: [
      ...
      },
      {
        ...
        name: "JSON Formatter",
        description:
          "Validate, format, and minify JSON data. Find syntax errors instantly.",
      ...
      },
      {
        ...
        name: "Data Cleaner",
        description:
          "Remove duplicates, empty rows, and invalid data from spreadsheets.",
  ...
  web: {
    ...
    philosophy:
      "Web development requires clean, optimized code. Our web tools help developers format, minify, and validate code for better performance and maintainability.",
    tools: [
      {
        id: "html-minifier",
        name: "HTML Minifier",
      ...
      },
      {
        ...
        name: "Code Formatter",
        description:
          "Format HTML, CSS, JavaScript, and JSON with proper indentation.",
...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Professional level ${category.name.toLowerCase()} for your local browser. ${category.tools.map((t) => t.name).join(", ")}. ${category.description}. No uploads, 100% private.`,
    keywords: [
      `online ${category.name.toLowerCase()}`,
      `free ${category.name.toLowerCase()} browser`,
      `privacy-first ${categoryId} tools`,
      ...category.tools.map((t) => t.name.toLowerCase()),
  ...
  const structuredData = {
    ...
    mainEntity: {
      ...
      itemListElement: category.tools.map((tool, index) => ({
        ...
        url: `${baseUrl}/tool/${categoryId}/${tool.id}`,
      })),
    },
  };
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
        ...
        <Card
          ...
          style={{ borderLeftColor: `hsl(var(--category-${category.color}))` }}
        >
