...
const documentation: Documentation[] = [
  {
    ...
    category: 'text',
    title: 'Word Counter',
    overview: 'The Word Counter tool provides instant, accurate statistics about your text content, including word count, character count, sentence count, and reading time estimates.',
    whenToUse: [
    ...
    usage: [
      { step: 'Navigate to Text Tools > Word Counter', detail: 'Access the tool from the main menu or category page' },
      { step: 'Upload a text file or paste content', detail: 'Supports .txt, .doc, and .docx files, or paste directly' },
      { step: 'View instant statistics', detail: 'See word count, character count (with/without spaces), sentences, and paragraphs' },
      { step: 'Adjust settings if needed', detail: 'Toggle space counting or punctuation analysis' }
    ],
    tips: [
    ...
    faqs: [
      {
        ...
        answer: 'No, punctuation marks are not counted as words. However, you can enable a separate punctuation count in the settings.'
      },
      {
        question: 'How accurate is the reading time estimate?',
        answer: 'The estimate is based on an average reading speed of 200 words per minute. Actual reading time varies based on content complexity and reader proficiency.'
      }
    ]
  },
  {
    ...
    overview: 'The Image Compressor reduces image file sizes while maintaining visual quality, perfect for web optimization and faster page loads.',
    whenToUse: [
    ...
    usage: [
      { step: 'Navigate to Image Tools > Image Compressor', detail: 'Select from the category page' },
      { step: 'Upload your image(s)', detail: 'Drag and drop or browse for .jpg, .png, or .webp files' },
      { step: 'Adjust compression quality', detail: 'Use the slider to balance file size and quality (80% recommended)' },
      { step: 'Process and download', detail: 'Click "Process File" and download your optimized image' }
    ],
    tips: [
    ...
    faqs: [
      {
        ...
        answer: '80% is ideal for most web images. Use 90-95% for professional photography, and 60-70% for thumbnails or less critical images.'
      },
      {
        question: 'Will compressing reduce image dimensions?',
        answer: 'No, compression reduces file size without changing dimensions. Use the Image Resizer tool if you need to change dimensions.'
      },
      {
        question: 'Is the compression lossy or lossless?',
        answer: 'The compression is lossy for JPEG and WebP formats, meaning some quality is traded for smaller file size. PNG compression can be lossless at 100% quality.'
      }
    ]
  },
  {
    ...
    category: 'pdf',
    title: 'PDF Merger',
    overview: 'Combine multiple PDF documents into a single file with customizable page ordering and optional bookmarks.',
    whenToUse: [
    ...
    usage: [
      { step: 'Navigate to PDF Tools > PDF Merger', detail: 'Access from the category menu' },
      { step: 'Upload PDF files', detail: 'Add multiple PDF files in the order you want them merged' },
      { step: 'Reorder if needed', detail: 'Drag files to reorder them before merging' },
      { step: 'Configure settings', detail: 'Enable bookmarks or page numbers if desired' },
      { step: 'Merge and download', detail: 'Process the files and download your merged PDF' }
    ],
    tips: [
    ...
    faqs: [
      {
        ...
        answer: 'No, PDFs must be unlocked before merging. Remove the password protection first, then merge the files.'
      },
      {
        question: 'Will the file size increase significantly?',
        answer: 'The merged PDF size is approximately the sum of individual file sizes. Some overhead may be added for bookmarks and metadata.'
      },
      {
        question: 'Can I select specific pages from each PDF?',
        answer: 'Currently, the merger combines entire PDFs. Use the PDF Splitter first to extract specific pages, then merge those extracted files.'
      }
    ]
  },
  {
    ...
    category: 'data',
    title: 'CSV Converter',
    overview: 'Convert CSV files to JSON, XML, or Excel formats with support for custom delimiters and header detection.',
    whenToUse: [
    ...
    usage: [
      { step: 'Navigate to Data Tools > CSV Converter', detail: 'Select from the data tools category' },
      { step: 'Upload your CSV file', detail: 'Support for .csv and .tsv files' },
      { step: 'Configure delimiter and headers', detail: 'Select the correct delimiter and specify if the first row contains headers' },
      { step: 'Choose output format', detail: 'Select JSON, XML, or Excel as your target format' },
      { step: 'Convert and download', detail: 'Process the file and download in your chosen format' }
    ],
    tips: [
    ...
    faqs: [
      {
        ...
        answer: 'You can select from common delimiters (comma, tab, semicolon, pipe) in the settings. If you need a custom delimiter, contact support.'
      },
      {
        question: 'Will data types be preserved in JSON output?',
        answer: 'All values are treated as strings by default. Numbers and booleans must be parsed by your application if needed.'
      },
      {
        question: 'Can I convert back from JSON to CSV?',
        answer: 'Yes, the converter works bidirectionally. Upload a JSON file and select CSV as the output format.'
      }
    ]
  },
  {
    ...
    category: 'web',
    title: 'HTML Minifier',
    overview: 'Minify HTML, CSS, and JavaScript code to reduce file sizes and improve website loading performance.',
    whenToUse: [
    ...
    usage: [
      { step: 'Navigate to Web Tools > HTML Minifier', detail: 'Access from web tools category' },
      { step: 'Upload your HTML, CSS, or JS file', detail: 'Supports all common web code formats' },
      { step: 'Configure minification settings', detail: 'Choose to remove comments, collapse whitespace, and minify inline styles' },
      { step: 'Minify and download', detail: 'Process the code and download your optimized file' }
    ],
    tips: [
    ...
    faqs: [
      {
        ...
        answer: 'No, the minifier preserves functionality while removing unnecessary characters. However, always test minified code before deployment.'
      },
      {
        question: 'How much file size reduction can I expect?',
        answer: 'Typical reduction is 20-40% for HTML and 40-60% for CSS/JavaScript, depending on code style and comments.'
      },
      {
        question: 'Can I reverse minification?',
        answer: 'No, minification cannot be fully reversed. Use code formatters to make minified code more readable, but original formatting and comments are lost.'
      }
    ]
  }
];
